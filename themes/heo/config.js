const CONFIG = {
  ...
  SITE_CREATE_TIME: '2023-08-23', // 建站日期，用于计算网站运行的第几天
  ...
  HERO_TITLE_1: '分享编程',
  HERO_TITLE_2: '与思维认知',
  HERO_TITLE_3: 'yyyzl.site',
  HERO_TITLE_4: '冷静思考',
  HERO_TITLE_5: '多看看天空',
  HERO_TITLE_LINK: 'https://www.yyyzl.site',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: 'Spring', url: '/tag/Spring' },
  HERO_CATEGORY_2: { title: 'Spring', url: '/tag/Spring' },
  HERO_CATEGORY_3: { title: 'Spring', url: '/tag/Spring' },
