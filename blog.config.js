...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'yyyzl', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个落魄的打工人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://www.yyyzl.site', // 网站地址
